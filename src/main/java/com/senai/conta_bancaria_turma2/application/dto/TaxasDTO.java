...
import com.senai.conta_bancaria_turma2.domain.entity.TaxasDescriçao;
...
public record TaxasDTO(
    ...
    public static TaxasDTO fromEntity(Taxas taxas) {
    ...
    public static TaxasDTO toEntity(Taxas taxas) {
        return TaxasDTO.builder()
                .id(taxas.getId())
                .descricao(taxas.getDescricao())
                .percentual(taxas.getPercentual())
